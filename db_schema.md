...
- sheets (id, course_id, title, exam_storage_path, solution_kind, solution_storage_path, solution_video_url, avg_difficulty, rating_count, view_count, interest_count, thumb_storage_path)
